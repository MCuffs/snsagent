...
const koreanPolicySections = [
  {
    ...
    body: [
      ...
      },
      {
        subtitle: '결제 관련 정보',
        paragraphs: [
          'Shuffla는 카드번호, CVC, 계좌번호 등 직접적인 결제수단 정보를 저장하지 않습니다. 결제는 외부 결제 제공자를 통해 처리됩니다.',
  ...
  },
  {
    title: '2. 개인정보의 이용 목적',
    paragraphs: [
      'Shuffla는 수집한 개인정보를 다음 목적으로 이용합니다.',
    ],
    items: [
      '회원 가입, 로그인 및 계정 관리',
    ...
    after: 'Shuffla는 이용자의 개인정보를 마케팅 목적으로 제3자에게 판매하지 않습니다.',
  },
  {
    title: '3. 개인정보의 보유 및 이용 기간',
    paragraphs: [
      'Shuffla는 개인정보의 수집 및 이용 목적이 달성되면 해당 정보를 지체 없이 삭제합니다. 다만, 서비스 운영 및 관련 법령에 따라 필요한 정보는 일정 기간 보관할 수 있습니다.',
    ],
    body: [
      {
        subtitle: '계정 정보',
  ...
  },
  {
    ...
    paragraphs: [
      'Shuffla는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다. 다만, 다음의 경우에는 예외적으로 제공될 수 있습니다.',
    ],
    items: [
      '이용자가 사전에 동의한 경우',
      '법령에 따라 요청받은 경우',
  ...
  },
  {
    ...
    paragraphs: [
      'Shuffla는 원활한 서비스 제공을 위해 다음 외부 서비스를 이용할 수 있습니다. 각 외부 서비스에는 서비스 제공에 필요한 최소한의 정보만 전달됩니다.',
    ],
    table: [
  ...
  },
  {
    ...
    paragraphs: [
      'Shuffla는 이용자가 입력한 주제, 키워드, 브랜드 정보, 업로드 이미지, 참고자료 등을 바탕으로 AI 콘텐츠를 생성합니다.',
  ...
  },
  {
    ...
    paragraphs: [
      'Shuffla는 로그인 유지, 사용자 설정 저장, 서비스 이용 분석, 오류 확인, 부정 이용 방지를 위해 쿠키 또는 유사 기술을 사용할 수 있습니다.',
  ...
  },
  {
    ...
    paragraphs: [
      'Shuffla는 개인정보의 보유 기간이 지나거나 처리 목적이 달성된 경우 해당 정보를 삭제합니다.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '요청은 아래 문의처를 통해 접수할 수 있으며, Shuffla는 본인 확인 후 관련 법령에 따라 처리합니다.',
  ...
  },
  {
    ...
    paragraphs: [
      'Shuffla는 개인정보 보호를 위해 다음과 같은 조치를 적용합니다.',
    ],
    items: [
      '개인정보 접근 권한 최소화',
      '관리자 계정 접근 통제',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '내용이 변경되는 경우 Shuffla는 서비스 내 공지 또는 웹사이트를 통해 안내합니다.',
      '공고일: 2026년 6월',
      '시행일: 2026년 6월',
    ],
  },
      ...
      <section className="mx-auto max-w-3xl px-5 py-20 md:px-8 md:py-28">
        ...
        {isKo ? (
          <div className="mt-10 space-y-9 text-sm leading-7 text-[#625c53]">
            ...
            <p>
              Shuffla는 이용자의 개인정보를 중요하게 생각하며, 관련 법령에 따라 개인정보를 안전하게 처리합니다.
              본 개인정보처리방침은 Shuffla가 제공하는 AI 기반 카드뉴스 및 SNS 콘텐츠 생성 서비스에서 개인정보를 어떻게 수집, 이용, 보관, 위탁 및 삭제하는지 안내합니다.
            </p>
