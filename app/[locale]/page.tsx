...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    title: locale === 'en' ? 'Shuffla - AI Card News Studio' : 'Shuffla - AI 카드뉴스 스튜디오',
    description: locale === 'en'
      ? 'AI content studio for analyzing brands, generating, editing, and downloading social card news.'
      : '브랜드 분석부터 카드뉴스 생성, 편집, 다운로드까지 이어지는 AI 콘텐츠 스튜디오.',
  }
}
