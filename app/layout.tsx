...
export const metadata: Metadata = {
  ...
  description: '브랜드 URL과 주제만 입력하면 AI가 영상 카드뉴스와 이미지 카드뉴스의 기획, 카피, 비주얼, Kling 영상 프롬프트까지 생성합니다 — AI Video Card News Generator for brands and marketers.',
  keywords: [
    // Korean
    '영상 카드뉴스', '영상 카드뉴스 생성', 'AI 영상 카드뉴스', '영상 카드뉴스 만들기',
    'Kling 영상 생성', 'AI 숏폼 카드뉴스', '숏폼 카드뉴스', '영상 콘텐츠 자동 생성',
    ...
    'Kling video generator', 'AI short form content', 'social video generator',
  ...
  openGraph: {
    ...
    description: '브랜드 URL과 주제만 입력하면 AI가 영상 카드뉴스 기획, 카피, Kling 영상 프롬프트, 이미지 카드뉴스까지 한 번에 만듭니다.',
    url: BASE_URL,
  ...
  twitter: {
    ...
    description: 'Create video card news and image card news from a brand URL and topic. AI plans, writes, visualizes, and prepares Kling video prompts.',
    images: ['/og-image.png'],
  },
  icons: {
