...
export class MockImageProvider implements ImageProvider {
  async generateImage(prompt: string): Promise<{ imageUrl: string }> {
    ...
    if (lowercasePrompt.includes('editorial') || lowercasePrompt.includes('documentary') || lowercasePrompt.includes('news') || lowercasePrompt.includes('photojournalism')) {
      category = 'editorial'
    } else if (lowercasePrompt.includes('cyberpunk') || lowercasePrompt.includes('neon')) {
      category = 'cyberpunk'
    ...
    const images: Record<string, string[]> = {
      editorial: [
        ...
        'https://images.unsplash.com/photo-1523995462485-3d171b5c8fa9?q=80&w=1080&auto=format&fit=crop',
        'https://images.unsplash.com/photo-1492724441997-5dc865305da7?q=80&w=1080&auto=format&fit=crop',
      ],
      cyberpunk: [
